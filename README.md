...
[![Pod Version](https://img.shields.io/badge/Version-0.1.2-8e8e8e)](https://github.com/lithiumtech/ios-brandmessenger-sdk-dist)
...
Add BrandMessenger to podfile:
    ...
    pod 'BrandMessenger', :git => 'git@github.com:lithiumtech/ios-brandmessenger-sdk-dist.git', :tag => '0.1.2'
